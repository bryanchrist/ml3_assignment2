...
model_ft.load_state_dict(torch.load('resnext_mlp.pth'))
...
#             preds = preds.max(dim=0)
        ...
        if min_valid_loss > valid_loss:
            ...
            # Saving State Dict
            torch.save(model.module.state_dict(), 'resnext_mlp.pth')
...
generate_submission(predictions, data_dir + '/sample_submission.csv', 'my_submission_resnext_mlp.csv')