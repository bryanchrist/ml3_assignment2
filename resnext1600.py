...
model_ft.fc = nn.Sequential(
    ...
    nn.Dropout(0.5),               # Dropout layer with 60% probability
...
#optimizer_ft = optim.Adam(model_ft.fc.parameters(), lr=0.0001, weight_decay=0.00005)
optimizer_ft = optim.Adam(model_ft.parameters(), lr=0.0001, weight_decay=0.08)
...
#             preds = preds.max(dim=0)
        ...
        if min_valid_loss > valid_loss:
            ...
            # Saving State Dict
            torch.save(model.module.state_dict(), 'resnext1600.pth')
...
generate_submission(predictions, data_dir + '/sample_submission.csv', 'my_submission_resnext_1600.csv')